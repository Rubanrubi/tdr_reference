        ...
        <div class="container">
            <div id="login-page" class="row">
                ...
                <div style="margin-top: 20vh;" class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                    ...
                    <form method="POST" action="{{ url('/')}}/creditor/password/reset">
                        @csrf
                        ...
                        <div class="row margin">
                            <div class="input-field col s12">
                                ...
                                <input id="email" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus type="email">
                        ...
                        <div class="row margin">
                            <div class="input-field col s12">
                                <i class="material-icons prefix pt-2">lock_outline</i>
                                <input id="password-confirm" name="password_confirmation" required autocomplete="new-password" type="password">
