...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/pages/page-404.min.css')}}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
        ...
        <div class="container"><div class="section section-404 p-0 m-0 height-100vh">
                <div class="row">
                    ...
                    <div class="col s12 center-align white">
                        <img src="{{ asset('assets/images/gallery/error-2.png')}}" class="bg-image-404" alt="">
                        <h1 class="error-code m-0">401</h1>
                        <h6 class="mb-2">UNAUTHORISED</h6>
{{--                        <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{route('admin.dashboard')}}">Back--}}
{{--                            TO Home</a>--}}
                    </div>
                </div>
            </div>
