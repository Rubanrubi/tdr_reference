            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>Subadmins List</span></h5>
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#">Subadmin</a>
                            </li>
                            <li class="breadcrumb-item active">Subadmin List
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="users-list-table">
                        <div class="card">
                            <div class="card-content">
                                <h4 class="card-title"><a class="waves-effect waves-light btn indigo right" href="{{route('admin.subadmin.add')}}"><i class="material-icons left">add</i> Add Subadmin</a></h4>
                                <br>
                                <!-- datatable start -->
    ...
    <script>
        ...
        $("#user_search").on("click",function(){
            ...
            $('#users-list-datatable').DataTable( {
                ...
                "bServerSide": true,
                "destroy": true,
                "sAjaxSource": "subadmin-list?status="+status,
